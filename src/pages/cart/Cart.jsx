...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_Vlli6czCb81bgG",
      key_secret: "BqxLAsqEZV3V4Cm4U86dNEV6",
  ...
  return (
    <Layout >
      <div className=" bg-gray-100 pt-5 h-full " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
